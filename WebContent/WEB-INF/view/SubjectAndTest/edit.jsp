...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/lib/jquery.validate.min.js"></script>
    <script src="${pageContext.request.contextPath}/static/lib/messages_zh.js"></script>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/assets/css/jquery-ui.custom.min.css" />
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                ...
                <form:form id="subjectForm" action="${user.subId}" method="post" modelAttribute="user">
                <table align="center">
                    <tr><td colspan="2"><h2 align="center">修改</h2></td></tr>
                    <tr>
                        <td>SubjectId</td>
                        <td><form:input path="subId" id="subId" name="subId"/><form:errors path="subId" cssClass="error" cssStyle="color:red;" /></td>
                    </tr>
                    <tr>
                        <td>Name</td>
                    ...
                    <tr>
                        <td>Description</td>
                        <td><form:input path="description" /><form:errors path="description" cssClass="error" cssStyle="color:red;" /></td>
                    </tr>
                    <tr>
                        <td>TestCount</td>
                        <td><form:input path="testCount" /><form:errors path="testCount" cssClass="error" cssStyle="color:red;" /></td>
                    </tr>
                    <tr>
                        <td>TotalTime</td>
                        <td><form:input path="totalTime" /><form:errors path="totalTime" cssClass="error" cssStyle="color:red;" /></td>
                    </tr>
                      <tr>
                        <td>TotalScore</td>
                        <td><form:input path="totalScore" /><form:errors path="totalScore" cssClass="error" cssStyle="color:red;" /></td>
                    </tr>
                      <tr>
                        <td>Status</td>
                        <td><form:input path="status" /><form:errors path="status" cssClass="error" cssStyle="color:red;" /></td>
                    </tr>
                    ...
                    <tr><td colspan="2">
                        <button class="btn" type="reset" style="position: relative;top:-40px;left:170px;">
                            Reset
                        </button></td>
                    </tr>
                </table>
                ...
                <script src="${pageContext.request.contextPath}/static/assets/js/date-time/bootstrap-datetimepicker.min.js"></script>
                ...
                <script src="${pageContext.request.contextPath}/static/assets/js/typeahead.jquery.min.js"></script>
...
<body>
<form:form id="userForm" action="add" method="post" modelAttribute="user">
    <table align="center">
        <tr><td colspan="2"><h2 align="center">添加</h2></td></tr>
        <tr>
            <td>Student_ID</td>
