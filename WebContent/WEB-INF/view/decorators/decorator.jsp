					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							...
							<c:if test="${sessionScope.user.gender == 0}">
								<img class="nav-user-photo" src="${pageContext.request.contextPath}/static/assets/avatars/user.jpg" alt="${sessionScope.user.userName}'s Photo" />
							</c:if>
							<c:if test="${sessionScope.user.gender == 1}">
								<img class="nav-user-photo" src="${pageContext.request.contextPath}/static/assets/avatars/avatar3.png" alt="${sessionScope.user.userName}'s Photo" />
							</c:if>
...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/static/assets/js/jquery.easypiechart.min.js"></script>
